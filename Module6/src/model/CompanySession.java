...
public class CompanySession extends Session {
    ...
    public CompanySession(Course course, Company orgCompany, Company sponsorName) {
        super(course, orgCompany);
        this.sponsor = sponsorName;
    }

    public CompanySession(Course course, Company orgCompany, Company sponsorName, List<Person> participants) {
        this(course, orgCompany, sponsorName);
        this.participants = participants;
    }

    public CompanySession(Course course, Company orgCompany, Company sponsorName, int amountParticipants) {
